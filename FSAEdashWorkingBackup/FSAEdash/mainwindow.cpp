...
void MainWindow::update(int speed, int rpm, int etc, int bat, int tps)
{
    ...
    if(dial<1){
        ...
        ui->speedD1->display(TPS);

        ui->GEARD1->display(TPS);
//        ui->LAPD1->display(TPS);
...
//    }
...

    {
        ...
        ui->MessageS->setPlainText("-------");
        ui->MessageD1->setPlainText("-------");
        ui->MessageD2->setPlainText("-------");
    }
