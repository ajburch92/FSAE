...
public:
	...
	int isrInit();
	int close_file();
	//GPIO(int pin_num, int rf_edge) {
	//	pin= pin_num;
	//	edge=rf_edge;
	//}
	
	int set_pin(int pin_number);
	int set_edge(char edge);//rising or falling
...
/* CAN connection to Engine Control Unit (ECU) variable notation is referenced as follows:
